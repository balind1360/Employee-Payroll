...
public class Admin{
    ...
    public void getPayroll(){
        ...
        try {
            fr = new FileReader("/Users/danabalin/Documents/AT2-Employee-Payroll/Current_Payroll.txt");
            in = new Scanner (fr);
        } catch (IOException e){
            return;
        }
        ...
        try{
            fw = new FileWriter("/Users/danabalin/Documents/AT2-Employee-Payroll/Current_Payroll.txt", false);
        ...
        try{
            fw = new FileWriter("/Users/danabalin/Documents/AT2-Employee-Payroll/Payroll.txt", false);
            out = new PrintWriter(fw);
        } catch(IOException e){
            System.out.println("Error opening output file: " + e);
            System.exit(1);
    ...
    public void addHoliday(LocalDate day){
        ...
        try{
            fw = new FileWriter("/Users/danabalin/Documents/AT2-Employee-Payroll/Current_Payroll.txt", true);
            out = new PrintWriter(fw);
        } catch(IOException e){
            System.out.println("Error opening output file: " + e);
            System.exit(1);
