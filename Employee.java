...
public class Employee {
    ...
    public double calculatePay (ArrayList<LocalDate> holidays){
        double pay = 0.0;
        
        //pay including overtime for hourly workers
        if (hourly){
            pay = hoursWorked * salary;
            ArrayList <LocalDate> bonusDays = checkNine (holidays);
            for (int i = 0; i < hoursAndDays.size (), i++){
